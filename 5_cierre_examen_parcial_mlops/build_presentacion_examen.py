"""Convierte presentacion_examen_parcial.md a PDF apaisado."""
...
MD = HERE / "presentacion_examen_parcial.md"
PDF = HERE / "Presentacion_Examen_Parcial.pdf"
...
.slide pre { font-size: 11px; background: #f4f6f8; padding: 8px; border-radius: 4px; white-space: pre-wrap; }
